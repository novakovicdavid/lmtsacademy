...
insert into event(id, title, start, finish, description) values (2, 'event2', '2022-05-10 2:00:00', '2022-05-11 3:00:00', 'description1');
insert into event(id, title, start, finish, description) values (3, 'event3', '2022-05-12 1:00:00', '2022-05-13 2:00:00', 'description1');
insert into event(id, title, start, finish, description) values (4, 'event4', '2022-05-15 1:00:00', '2022-05-17 2:00:00', 'description1');
