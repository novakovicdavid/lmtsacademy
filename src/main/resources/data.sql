...
values ((nextval('EVENT_SEQ')), 'cursus','2022-05-10 2:00:00', '2022-05-11 3:00:00', 'description1', 1);
insert into event(id, title, start, finish, description, EMPLOYEE_ID)
values ((nextval('EVENT_SEQ')), 'webinar','2022-06-10 2:00:00', '2022-06-11 3:00:00', 'description1', 2);
insert into event(id, title, start, finish, description, EMPLOYEE_ID)
values ((nextval('EVENT_SEQ')), 'webinar','2022-08-11 2:00:00', '2022-08-12 3:00:00', 'description1', 3);
insert into event(id, title, start, finish, description, EMPLOYEE_ID)
values ((nextval('EVENT_SEQ')), 'meeting dans','2022-05-19 16:00:00', '2022-05-19 18:00:00', 'description1', 3);
insert into event(id, title, start, finish, description, EMPLOYEE_ID)
values ((nextval('EVENT_SEQ')), 'meeting zang','2022-05-19 9:00:00', '2022-05-19 14:00:00', 'description1', 3);
insert into event(id, title, start, finish, description, EMPLOYEE_ID)
values ((nextval('EVENT_SEQ')), 'staking','2022-05-12 2:00:00', '2022-05-13 3:00:00', 'description1', 3);
insert into event(id, title, start, finish, description, EMPLOYEE_ID)
values ((nextval('EVENT_SEQ')), 'lunch','2022-05-12 2:00:00', '2022-05-13 3:00:00', 'lunch met Anna', 3);
insert into event(id, title, start, finish, description, EMPLOYEE_ID)
values ((nextval('EVENT_SEQ')), 'paper','2022-05-12 2:00:00', '2022-05-13 3:00:00', 'paper', 3);
insert into event(id, title, start, finish, description, EMPLOYEE_ID)
values ((nextval('EVENT_SEQ')), 'schooltaak','2022-05-12 2:00:00', '2022-05-13 3:00:00', 'taak design', 3);
insert into event(id, title, start, finish, description, EMPLOYEE_ID)
values ((nextval('EVENT_SEQ')), 'meeting','2022-05-12 2:00:00', '2022-05-13 3:00:00', 'Meeting met Femke', 3);
insert into event(id, title, start, finish, description, EMPLOYEE_ID)
values ((nextval('EVENT_SEQ')), 'meeting','2022-05-12 2:00:00', '2022-05-13 3:00:00', 'Meeting met Sharon', 3);
insert into event(id, title, start, finish, description, EMPLOYEE_ID)
values ((nextval('EVENT_SEQ')), 'meeting','2022-05-12 2:00:00', '2022-05-13 3:00:00', 'Meeting me Yanis', 3);
