...
INSERT INTO COURSE (ID,NAME,DESCRIPTION,SHORTDESCRIPTION,LOCATION,WORKSHOP) VALUES(nextval('COURSE_SEQ'),'Dans','Deze dansles is speciaal voor mensen met een verstandelijke beperking. Ze leren verschillende dansen, losse dansen met eenvoudige bewegingen, party dance, maar ook stijldansen zoals Quickstep, Engelse wals, ChaChaCha en Tango. \nBij deze groep is het vooral belangrijk dat ze zich even lekker kunnen bewegen en uiten en dat ze andere mensen ontmoeten. Ervaring leert dat ze het als heel erg leuk ervaren en dit met heel veel plezier doen.
...
INSERT INTO TEACHER (ID,NAME,BIO,EXPERIENCE) VALUES(nextval('TEACHER_SEQ'),'JOEP DE KLEINE','Hallo ik ben Joep, ik ben 27 jaar en werk reeds 3 jaar bij "Creative Spirits". Ik ben de zanginstructeur en help soms ook mee als assistent bij de danscursussen die wij ook aanbieden. Zingen voor een publiek is niet voor iedereen weggelegt maar ik doe er alles aan om de beste zanger in je boven te halen','Master aan de Dutch National Opera Acedemy,2 jaar hiphop en 6 jaar in een band ');
...
insert into TEACHER_COURSES (TEACHER_ID,COURSES_ID) values (0,0);
